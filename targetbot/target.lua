...
targetbotMacro = macro(100, function()
  ...
  -- Add logging for highestPriorityParams
  if highestPriorityParams then
     -- logInfo("Targetbot Macro: highestPriorityParams set for creature: " .. highestPriorityParams.creature:getName())
  else
     -- logInfo("Targetbot Macro: highestPriorityParams is nil")
  end
...
-- Public function to get the current target's position
function TargetBot.getCurrentTargetPosition()
 --   logInfo("getCurrentTargetPosition: called")
    if highestPriorityParams and highestPriorityParams.creature then
      --  logInfo("getCurrentTargetPosition: highestPriorityParams.creature exists, returning position")
        return highestPriorityParams.creature:getPosition()
    else
      --  logInfo("getCurrentTargetPosition: highestPriorityParams or creature is nil, returning nil")
    end
    return nil
end
