...
function getInactiveItemId(itemId)
    local inactiveIds = {
        ...
        [3050] = 3051, -- Power Ring
        [3006] = 3007, -- Ring of Healing (old)
        
        -- Amulets
        [3012] = 3013, -- Stone Skin Amulet
        [3081] = 3082, -- Stone Skin Amulet (old)
        
        -- Outros
        [8905] = 8906, -- Rainbow Shield
        [8899] = 8900, -- Coconut Shield
    }
...
function getActiveItemId(itemId)
    local activeIds = {
        -- Rings
        [3089] = 3088, -- Life Ring
        [3099] = 3098, -- Ring of Healing
        [3051] = 3050, -- Power Ring
        [3007] = 3006, -- Ring of Healing (old)
        
        -- Amulets
        [3013] = 3012, -- Stone Skin Amulet
        [3082] = 3081, -- Stone Skin Amulet (old)
        
        -- Outros
        [8906] = 8905, -- Rainbow Shield
        [8900] = 8899, -- Coconut Shield
    }
    
    return activeIds[itemId] or itemId
end

-- ════════════════════════════════════════════════════════
-- INTERFACE DO EQUIPPER
-- ════════════════════════════════════════════════════════
